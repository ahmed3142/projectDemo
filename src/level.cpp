    ...
    targetTileX(tileCountX/2), targetTileY(tileCountY/2)
{
    ...
    Texture2D *targetTex = TextureLoader::LoadTextureFromFile("Tile Target3.png");
    ...
    Texture2D *backgroundxtex = TextureLoader::LoadTextureFromFile("Backgroundx Tile.png");
...
{
    // DrawTexture(textureTileBackgroundx, 0 ,0 ,Fade(WHITE, 1.0f));
