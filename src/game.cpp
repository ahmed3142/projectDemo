      ...
      money(baseMoney)
{
    ...
    backgroundMusic = LoadMusicStream("E:/1-2 Courses/Structured Programming LAB/projectDemo-finalRender/projectDemo-finalRender/src/assets/Audios/backgroundMusic.mp3");
   ...
   // cannonBlastSound = LoadSound("assets/audio/cannon_blast.wav");
    ...
    buttonHoverSound = LoadSound("E:/1-2 Courses/Structured Programming LAB/projectDemo-finalRender/projectDemo-finalRender/src/assets/Audios/buttonHover.wav");
