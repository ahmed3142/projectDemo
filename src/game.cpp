      ...
      money(baseMoney)
{
    ...
    backgroundMusic = LoadMusicStream("D:/ProjectUpdate/projectDemo-Today/projectDemo-Today/src/assets/Audios/backgroundMusic.mp3");
...
void Game::draw()
{
    ...
    if (currentState == GameUIState::Playing)
    {
        ...
        std::snprintf(healthBuffer, sizeof(healthBuffer), "Target Health: %.2f", targetHealth / 100.0f);

        DrawText(("Money: " + std::to_string(money)).c_str(), 30, 20, 30, NEON_BLUE);
